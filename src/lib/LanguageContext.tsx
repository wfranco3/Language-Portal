...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    teacherHelenaSantos: 'Profa. Helena Santos',
  ...
  en: {
    ...
    teacherHelenaSantos: 'Prof. Helena Santos',
  ...
  id: {
    ...
    footerBranding: 'LANG-PORTAL • STUDENT PORTAL • EST. 2026',
    teacherHelenaSantos: 'Guru Helena Santos',
